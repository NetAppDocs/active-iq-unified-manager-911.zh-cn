...
您可以更新版本系列中的 OpenJDK 版本。例如、您可以从OpenJDK 11.0.12升级到OpenJDK 11.0.13、但不能直接从OpenJDK 11更新到OpenJDK 12。
...
. 展开 `zip` 文件
. 从生成的复制目录和文件 `jdk` 目录(例如、 `jdk-11.0.13` 到Java的安装位置。示例 `C:\Program Files\NetApp\JDK\`
